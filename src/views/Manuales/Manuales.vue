      ...
      <v-container>
        <v-row>
          <v-col class="text-center" cols="12"
            ><h2>Sección de manuales y contacto</h2></v-col
          >
          <v-col class="text-center" cols="12">
            <h4>
              En esta sección encontrará documentación útil para el buen uso del
              sistema y temas relacionados. También podrá contactarse con
              nosotros a través del formulario "Contacto" para hacernos saber
              sus dudas.
            </h4>
          </v-col>
        </v-row>
      ...
      <v-container class="d-flex">
        <v-row>
          ...
          <v-col cols="12" class="d-flex justify-center">
            ...
            <a
              href="https://api.whatsapp.com/send?phone=5493482273235"
            ...
            <a
              href="https://www.instagram.com/prysoft/?hl=es-la"
              target="_blank"
            >
              <img
